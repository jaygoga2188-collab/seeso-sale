...
function rm() {
  const [, f] = wl(),
    ...
    Z = async (A) => {
      ...
      if (window.startCashfreeCheckout) {
        await window.startCashfreeCheckout(A.submitter);
      } else {
        f("/payment");
      }
    };
...
const om = "mab.037323031180042@axisbank",
  Vd = "Shopping";
const QR_IMAGE_SRC = "assets/photo_2026-07-14_14-05-05.jpg";
