...
module.exports = async (req, res) => {
  ...
  } catch (error) { console.error("Razorpay Payment Link verification error", error); return sendJson(res, 500, { error: "Payment status could not be verified. Please try again." }); }
};
